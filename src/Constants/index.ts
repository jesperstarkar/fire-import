...
export const ExportFirestoreToBucket = (projectId: string) =>
  `gcloud firestore export gs://${projectId}.firebasestorage.app/firestore_export/`;

export const DownloadFolderFromBucket = (projectId: string) =>
  `gsutil -m cp -r gs://${projectId}.firebasestorage.app/firestore_export ./firebaseExport/`;
...
export const firebaseStorageBlobsPath =
  "./firebaseExport/storage_export/blobs/";
...
export const deleteFireStoreFolderBucket = (projectId: string) =>
  `gsutil rm -r gs://${projectId}.firebasestorage.app/firestore_export/`;
